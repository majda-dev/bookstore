...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha256-kBubKCyKx7GD0vNXudUjr0lTle5nqul3zU8wOEwqpBI=" crossorigin="anonymous">
          ...
          @auth
            <li class="nav-item">
                <form action="{{ route("logout") }}" method="GET">
                    @csrf
                    <button type="submit" class="nav-link" style="border: none; background: none; cursor: pointer;">Logout <span>/</span></button>
                </form>
            </li>
         @else
            <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">Login <span>/</span></a>
            </li>
         @endauth
