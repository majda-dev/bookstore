...
<section class="section contact-form">
    <div class="container">
        ...
        <form class="row" method="POST" action="{{ route('book_series.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-md-12">
                <label class="form-label" for="name">Name:</label>
                <input type="text" class="form-control main" name="name" id="name" placeholder="Book series's name" required>
            </div>
        ...
        <div class="col-md-12">
            ...
            <input type="number" class="form-control main" name="number_of_books" id="number_of_books" placeholder="number_of_books" required>
        </div>
