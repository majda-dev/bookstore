...
<section class="section contact-form">
	<div class="container">
        ...
        <form class="row" method="POST" action="" enctype="multipart/form-data">
            @csrf
			<div class="col-md-12">
				<input type="name" class="form-control main" name="name" id="name" value="{{ $admin->user->name }}">
			</div>
            <div class="col-md-12">
				<input type="email" class="form-control main" name="email" id="email" value="{{ $admin->user->email }}">
			</div>
            {{-- <div class="col-md-6">
            ...
            @if($admin->privilege==1)
            {
                ...
                <div class="col-md-4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="privilege" id="super_admin"
                        value="super_admin" {{ ($admin->privilege=='super_admin') ? 'checked' : '' }}>
                ...
                <div class="col-md-4">
                    <div class="form-check form-check-inline" >
                        ...
                        value="admin"  {{ ($admin->privilege=='admin') ? 'checked' : '' }}>
            ...
            <div class="col-12 text-center">
                <a href="{{  route('admins.editPassword', ['id' => $admin->user->id]) }}" class="psw_change">Change your password?</a>
            </div>
